...
pub struct Attribute {
    ...
    modifiers: Vec<AttributeModiier>,
}
...
impl Attribute {
    ...
    pub fn add_modifier(&mut self, modifier: &AttributeModiier) {
    ...
    pub fn remove_modifier(&mut self, modifier: &AttributeModiier) {
    ...
    fn apply_modifier(&mut self, modifier: &AttributeModiier) {
        match modifier.operation {
            ModifierOperation::Absolute => {
...
impl PartialEq for AttributeModiier {
    fn eq(&self, other: &Self) -> bool {
        self.uuid == other.uuid
    }
}

impl Eq for AttributeModiier {}

impl Hash for AttributeModiier {
...
mod tests {
    ...
    fn test_attribute() {
        ...
        let mut absolute_modifier = AttributeModiier::empty();
        ...
        let mut percentage_modifier = AttributeModiier::empty();
        ...
        let mut override_modifier1 = AttributeModiier::empty();
        ...
        let mut override_modifier2 = AttributeModiier::empty();
